...
const CourseForm = (props) => {
  ...
  const onSave = (e) => {
    ...
    frmdata.append(
      "short_description",
      _.get(mycourse, "short_description", "")
    );
    ...
    setSaving(true);
    setServerData("trainer/my-courses", frmdata).then((res) => {
      setSaving(false);
      setResponse(res);
      props.onSave();
      props.onClose();
    ...
    return (
      <>
        ...
        <Form.Control
          ...
          size="lg"
          name={fld}
          accept=".jpeg,.png,.jpg,JPEG;"
        />
        {_.get(mycourse, "course_image", "") !== "" && (
          <img
            className="thumbnail mt-3"
            src={`${process.env.REACT_APP_API_URL}/uploads/courses/${mycourse.course_image}`}
          />
        )}
      </>
    );
  ...
  const renderForm = () => (
    ...
    >
      <Form.Control
        type="hidden"
        name="id"
        defaultValue={_.get(mycourse, "id", "")}
      />
      <Form.Control
        type="hidden"
        name="mid"
        defaultValue={_.get(mycourse, "moodle_id", "")}
      />
      <Form.Control
        type="hidden"
        name="old_product_image"
        defaultValue={_.get(mycourse, "product_image", "")}
      />
      <Row>
        <Col md={12} className="mt-3">
          ...
          <Form.Control
            ...
            defaultValue={_.get(mycourse, "name", "")}
            required
          />
      ...
      <Row>
        <Form.Control
          type="hidden"
          name="sku"
          defaultValue={_.get(mycourse, "sku", "")}
        />
        ...
        <Col md={8} className="mt-4">
          ...
          <Form.Control
            ...
            defaultValue={_.get(mycourse, "slug", "")}
          />
        </Col>
      </Row>
      ...
      <Row>
        <Col md={3} className="mt-3">
          {photoUploader(
            "course_image",
            "Upload product image (Image dimension should be 1000cm x 667cm)"
          )}
        </Col>
        <Col md={9} className="mt-3">
          ...
          />
          <div className="short_description invalid-feedback">
      ...
      <Row>
        <Col md={12} className="mt-3">
          ...
          <Editor
            ...
            required
          />
          <div className="description invalid-feedback">
      ...
      <Row>
        <Col md={4} className="mt-3">
          ...
          <Form.Control
            as="select"
            name="level"
            defaultValue={_.get(mycourse, `level`, "")}
            required
          >
            <option value=""> - Select Level - </option>
            {Utils.courseLevel.map((v) => (
              <option
                key={v}
                selected={v == _.get(mycourse, `level`, "")}
                value={v}
              >
                {v}
              </option>
        ...
        <Col md={4} className="mt-3">
          ...
          <Form.Control
            as="select"
            name="language"
            defaultValue={_.get(mycourse, `language`, "")}
            required
          >
            ...
            {Utils.country.map((v) => (
              <option
                key={v}
                selected={v == _.get(mycourse, `language`, "")}
                value={v}
              >
                {v}
              </option>
      ...
      <Row>
        ...
        <Col md={4} className="mt-3">
          ...
          <Form.Control
            ...
            defaultValue={_.get(mycourse, "duration", "")}
          />
        </Col>
        {/*<Col md={4} className="mt-3">
