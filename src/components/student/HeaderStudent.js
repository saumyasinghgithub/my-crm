      ...
      <div className="sidenav">
        <div className="sidebarInner">
          ...
          <ul className="navList">
            <li>
              <a href={`${process.env.REACT_APP_PUBLIC_URL}/about-us`}>
                About us <span>Any queries? Problems with upload? No matter what the issue is, we will help, support and find a way!</span>
              </a>
            </li>
            <li>
              <a href={`${process.env.REACT_APP_PUBLIC_URL}/ad-studio`}>
                AD Studio <span>World best learning plaform.</span>
              </a>
            </li>
            <li>
              <a href={`${process.env.REACT_APP_PUBLIC_URL}/ad-trainer`}>
                Help for Trainer <span>Get to know us, get to work with us.</span>
              </a>
            </li>
            <li>
