...
const LandingPage = (props) => {
    ...
    const poster = 'https://static.wixstatic.com/media/dacb90_f7f587e79fd14896a3f30e5a475c1e99~mv2.png/v1/fill/w_648,h_366,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/dacb90_f7f587e79fd14896a3f30e5a475c1e99~mv2.png';
            ...
            <Row className="landingPageRow">
                <Col md={11} className="landingSlider">
                    <MDBCarousel showIndicators fade>
                        ...
                        >
                            ...
                            <h4><span>— Dr. Susan Davis</span></h4>
                ...
                <Col md={10} className="landingEventsHeading">                    
                    <div className="landingEventsDiv">
                        <h4>OUR UPCOMING EVENTS &nbsp;&nbsp;<FontAwesomeIcon icon={faCalendarAlt} /></h4>                        
                    </div>
                </Col>
                <Col md={10} className="landingEventsSection">
                    ...
                    <p className='eventDescription'>Do you strut into a code blue with confidence, knowing you're going to nail it, no matter what? Or do you stumble in with unease and anxiety, feeling unprepared and overwhelmed? Let's face it, code blue events can leave you feeling like you've been hit by a bus, and that's not a good look on anyone.</p>
                    <p className='eventDescription'>Can you make it?</p>
                    <p className='eventRegisBtn'><a href="" >Register Now</a></p>
                    <div className='socialLinksEvents'>
                        <a href=""><FontAwesomeIcon icon={faFacebook} className="fontawesomeCustomClass"/></a>
                        <a href=""><FontAwesomeIcon icon={faTwitter} className="fontawesomeCustomClass"/></a>
                        <a href=""><FontAwesomeIcon icon={faLinkedin} className="fontawesomeCustomClass" /></a>
                    </div>
                </Col>
                <Col md={10} className="landingEvents">
                </Col>
