            ...
            <ol className="cd-breadcrumb">
               ...
               <li className="current"><em>Terms Of Service</em></li>
                    ...
                    <div className="AD-studio">
                        ...
                        <p className="slideInUp wow">The information found on this website has been provided by Tverse. By accessing this website, you accept these terms and conditions in full. Accordingly, if you disagree with these terms and conditions or any part of these terms and conditions, you must not use or download content on this website.</p>
                        ...
                        <p className="slideInUp wow">Clients listed on this website reflect both direct clients and indirect clients. Logos of companies other than Tverse are the trademarks of the respective companies.</p>
                        ...
                        <p className="slideInUp wow">This website may contain information that is created and maintained by a variety of sources both internal and external to Tverse. These sites may be unmoderated forums containing the personal opinions and other expressions of the people who post entries. Tverse does not control, monitor or guarantee the information contained in these sites or information contained in links to other external web sites, and does not endorse any views expressed or products or services offered therein. Any links to external websites provided on this website are provided as a courtesy. They should not be construed as an endorsement by Tverse of the content or views of the linked materials.</p>
