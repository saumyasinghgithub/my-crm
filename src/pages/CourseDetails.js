    ...
    <div className="cardWrapper">
        <div className="container">
            <nav className="breadcrumb-list" aria-label="breadcrumb">
                <span className="backarrow"><a href={`${process.env.PUBLIC_URL}/search-results`}><img src="/assets/images/back-arrow.png" alt="AD" />Back to search</a></span>
                <ol className="breadcrumb">
                  <li className="breadcrumb-item active">{course.course.name}</li>                  
