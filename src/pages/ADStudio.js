            ...
            <div className="AD-studio">
               <div className="row">
                  <div className="col-sm-12">
                     ...
                     <p>Tverse is a Global virtual marketplace dedicated towards bringing the best training minds under one roof so that they can be found by their potential audience.</p>
               ...
               <div className="row">
                  <div className="col-sm-12">
                     ...
                     <ul>
                        <li>Create a free Digital Presence in a Global Virtual Market Place (Membership only by invitation or after successful screening and validation of the Trainers background by the Tverse expert panel).</li>
